...
@Client.on_message(filters.command(["dban"], prefix) & filters.me)
async def dban_command(client: Client, message: Message):
    handler = BanHandler(client, message)
    await handler.handle_ban(delete_replied=True)
...
@Client.on_message(filters.command(["dkick"], prefix) & filters.me)
async def dkick_command(client: Client, message: Message):
    handler = KickHandler(client, message)
    await handler.handle_kick(delete_replied=True)
...
@Client.on_message(filters.command(["mute", "tmute"], prefix) & filters.me)
...
@Client.on_message(filters.command(["dmute"], prefix) & filters.me)
async def dmute_command(client: Client, message: Message):
    handler = MuteHandler(client, message)
    await handler.handle_mute(delete_replied=True)
    update_cache()


@Client.on_message(filters.command(["unmute", "tunmute"], prefix) & filters.me)
...
modules_help["admintool"] = {
    ...
    "dban [reply]* [reason]": "ban user and delete their replied message",
    "unban [reply]/[username/id]* [reason]": "unban user in chat",
    "kick [reply]/[userid]* [reason]": "kick user out of chat",
    "dkick [reply]* [reason]": "kick user and delete their replied message",
    "mute [reply]/[userid]* [reason] [1m]/[1h]/[1d]/[1w]": "mute user (restrict permissions + auto-delete incoming messages)",
    "dmute [reply]* [reason] [1m]/[1h]/[1d]/[1w]": "mute user and delete their replied message",
    "unmute [reply]/[userid]* [reason]": "unmute user (restores permissions + removes auto-deletion)",
    "promote [reply]/[userid]* [prefix]": "promote user in chat",
    "demote [reply]/[userid]* [reason]": "demote user in chat",
    "tmute_users": "list of tmuted/muted users",
